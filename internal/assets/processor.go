...
// ProcessCSS replaces {$varname} placeholders in CSS with actual values.
func ProcessCSS(css []byte, vars map[string]string) []byte {
	s := string(css)
...
// DefaultTheme contains the CSS variable map for the default (light) theme.
// Extracted from CelerityDefaultPostprocessor.php.
var DefaultTheme = map[string]string{
	// Fonts
	"basefont":   "13px 'Segoe UI', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Lato', 'Helvetica Neue', Helvetica, Arial, sans-serif",
	"fontfamily": "'Segoe UI', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Lato', 'Helvetica Neue', Helvetica, Arial, sans-serif",
...
// DarkTheme contains the CSS variable map for the dark mode theme.
// Extracted from CelerityDarkModePostprocessor.php.
